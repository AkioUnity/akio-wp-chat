...
*/
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(i){return typeof i}:function(i){return i&&"function"==typeof Symbol&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i},$jscomp=$jscomp||{};$jscomp.scope={},$jscomp.ASSUME_ES5=!1,$jscomp.ASSUME_NO_NATIVE_MAP=!1,$jscomp.ASSUME_NO_NATIVE_SET=!1,$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(i,j,o){i!=Array.prototype&&i!=Object.prototype&&(i[j]=o.value)},$jscomp.getGlobal=function(i){return"undefined"!=typeof window&&window===i?i:"undefined"!=typeof global&&null!=global?global:i},$jscomp.global=$jscomp.getGlobal(void 0),$jscomp.SYMBOL_PREFIX="jscomp_symbol_",$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){},$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)},$jscomp.Symbol=function(){var i=0;return function(j){return $jscomp.SYMBOL_PREFIX+(j||"")+i++}}(),$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var i=$jscomp.global.Symbol.iterator;i||(i=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator")),"function"!=typeof Array.prototype[i]&&$jscomp.defineProperty(Array.prototype,i,{configurable:!0,writable:!0,value:function value(){return $jscomp.arrayIterator(this)}}),$jscomp.initSymbolIterator=function(){}},$jscomp.arrayIterator=function(i){var j=0;return $jscomp.iteratorPrototype(function(){return j<i.length?{done:!1,value:i[j++]}:{done:!0}})},$jscomp.iteratorPrototype=function(i){return $jscomp.initSymbolIterator(),i={next:i},i[$jscomp.global.Symbol.iterator]=function(){return this},i},$jscomp.makeIterator=function(i){$jscomp.initSymbolIterator();var j=i[Symbol.iterator];return j?j.call(i):$jscomp.arrayIterator(i)};var indexOf="function"==typeof Array.prototype.indexOf?function(i,j){return i.indexOf(j)}:function(i,j){for(var o=0,q=i.length,r=-1,s=!1;o<q&&!s;)i[o]===j&&(r=o,s=!0),o++;return r};var nBirdEvents=function(){this.events={}};nBirdEvents.prototype.on=function(i,j){"object"!==_typeof(this.events[i])&&(this.events[i]=[]),this.events[i].push(j)},nBirdEvents.prototype.off=function(i,j){if("object"===_typeof(this.events[i])){var o=indexOf(this.events[i],j);-1<o&&this.events[i].splice(o,1)}},nBirdEvents.prototype.emit=function(i){var j,o=[].slice.call(arguments,1);if("object"===_typeof(this.events[i])){var q=this.events[i].slice(),r=q.length;for(j=0;j<r;j++)q[j].apply(this,o)}},nBirdEvents.prototype.once=function(i,j){this.on(i,function o(){this.off(i,o),j.apply(this,arguments)})};var nightBird=function(i,j){this.opts=i,this.str=j,this.event=lcx_events,this._i=this.opts._iframe,this._d=this._i.contentWindow.document,this._w=this._i.contentWindow.window,this._widget=this._i.parentNode,this._wstate=!0,this._wtitle=document.title,this._cardtimeout=this._wtimeout=!1,this._mode="loading",this._pstate=!1,this._popup="",this._chatid=sessionStorage.getItem("lcx-chatid")||"",this._chat=null,this._lastchatid="",this._chats={},this._unreads={},this._lastBreak=this._lastPlatform=this._lastuid="",this._dbInit=!1,this._initMsg="",this._cnvList={},this._isMobile=!1,this._user=this._uname=this._uid="",this.$_msgs={},this.$_members={},this.$_profile={},this.$_operators={},this.$_onlineOps={},this.$_chats={},this.opts.autoinit&&this.init()};nightBird.prototype.init=function(){var i=this;this.$btn=this._d.getElementById("lcx-starter"),this.$menu=this._d.getElementById("lcx-menu"),this.$ntf=this._d.getElementById("lcx-ntfs"),this.$popup=this._d.getElementById("lcx-popup"),this.$pbody=this._d.getElementById("lcx-popup-body"),this.$pchead=this._d.getElementById("lcx-pcontent-header"),this.$pcbody=this._d.getElementById("lcx-pcontent-body"),this.$pcfoot=this._d.getElementById("lcx-pcontent-footer"),this.opts.hideOffline&&this._widget.classList.add("lcx--hidden"),firebase.initializeApp({apiKey:this.opts.db.apiKey,authDomain:this.opts.db.authDomain,databaseURL:this.opts.db.databaseURL}),this.db=firebase.database(),this.auth=firebase.auth(),this.db.ref(".info/connected").on("value",function(j){!0===j.val()?(i._isFirstConn=!1,i._onConnect()):i._onDisconnect("networkError")}),this.auth.onAuthStateChanged(function(j){i._onAuthState(j)}),this.__msgWrap=this._d.getElementById("__lcx-msg--wrapper").innerHTML,this.actions(),this.actions(document),this._uiEvents()},nightBird.prototype._uiEvents=function(){var i=this;this._pstate&&setTimeout(function(){i.open(i._popup)},300),this.$btn.addEventListener("click",function(o){o.preventDefault(),i._pstate?i.close():i.open()}),this.$menu.addEventListener("click",function(o){o.preventDefault(),i.open("cnv")}),this.$popup.addEventListener("mouseenter",function(){i.readChat()});var j=function(){(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth)<=i.opts.mobileBreakpoint?(i._widget.classList.add("lcx-mobileView"),i._d.body.classList.add("lcx-mobileView"),i._isMobile=!0):(i._widget.classList.remove("lcx-mobileView"),i._d.body.classList.remove("lcx-mobileView"),i._isMobile=!1)};j(),window.addEventListener("resize",j,!0)},nightBird.prototype.actions=function(i){var j=this;if(i=i?i:this._d,i=i.getElementsByClassName("lcx-action"))for(var o=function(r){r.preventDefault(),r=this.getAttribute("data-action"),"openPopup"===r?(r=this.getAttribute("data-value"))||!j._pstate?j.open(r):j.close():"closePopup"===r?j.close():"newChat"===r?(r=this.getAttribute("data-value"),j.resetChat(),j.open("online"),j.delAttr("offline"),r=r?[r]:null,j.createTmpChat(r)):"endChat"===r?j.updateChat({status:"close"}):"online"===r||"away"===r?j.mode(r):"sendReply"===r?j.$popup.querySelector(".lcx-reply").dispatchEvent(new KeyboardEvent("keydown",{keyCode:13})):void 0},q=0;q<i.length;q++)i[q].addEventListener("click",o)},nightBird.prototype.open=function(i,j){j||this._popup&&i||(i=localStorage.getItem("lcx-popup")||this.opts.initPopup),this.opts.allowedPopups.includes(i)||(i=this.opts.initPopup),this._d.body.classList.add("lcx--open"),this._widget.classList.add("lcx--open"),this.$btn.classList.add("lcx--active"),this.$popup.classList.add("lcx--active"),this._pstate=!0,this.goPage(i),this.delAppMsgs(),this._isMobile&&(document.body.style.overflow="hidden",document.body.style.position="fixed",document.body.style.width="100%",document.body.style.height="100%"),this._onOpenPopup()},nightBird.prototype.close=function(){this._d.body.classList.remove("lcx--open"),this._widget.classList.remove("lcx--open"),this.$btn.classList.remove("lcx--active"),this.$popup.classList.remove("lcx--active"),this._pstate=!1,document.body.style.overflow="",document.body.style.position="",document.body.style.width="",document.body.style.height="",this._onClosePopup()},nightBird.prototype.resetUser=function(){var i=this.db.ref("users/"+this._uid);i.off(),i.child("/lastSeen").onDisconnect().cancel(),this._user=this._uname=this._uid="",this.$_profile={},window.localStorage.removeItem("lcx-refreshToken")},nightBird.prototype.startSess=function(){var i=this.db.ref("users/"+this._uid+"/sessions/"+this.opts.platform);i.set({started:firebase.database.ServerValue.TIMESTAMP}),i.onDisconnect().remove()},nightBird.prototype.startChat=function(i,j){var o=this,q=this.db.ref("chats").push(),r=q.key,s=firebase.database.ServerValue.TIMESTAMP,t=this._uid,u={name:this._uname,subject:i,lastMsg:i,date:s,visitorid:t,status:"init",type:"support"};this.db.ref("caseNo").transaction(function(v){return(v||100222E3)+1}).then(function(v){return u.caseNo=v.snapshot.val(),q.set(u)}).then(function(){return o.db.ref("members/"+r+"/"+t).set({chatid:r})}).then(function(){return o.db.ref("users/"+t+"/chatsAsVisitor/"+r).set(!0)}).then(function(){return o.db.ref("messages/"+r).push({chatid:r,date:s,msg:i,name:o._uname,platform:"frontend",photoURL:o._user.photoURL,uid:o._uid,type:j||"basic"})}).then(function(){o.showCollector(),o.openChat(r),o._onNewChat(r)})["catch"](function(v){o.createNtf(v.message,"error"),console.error(v)})},nightBird.prototype.openChat=function(i){i in this.$_chats&&(this._lastchatid=this._chatid=i,sessionStorage.setItem("lcx-chatid",i),this._chat=this.$_chats[i],this.attr("chat-id",i),this.attr("chat-status",this._chat.status),this._lastchatid!==i&&this._onOpenChat(i,this._chat))},nightBird.prototype.resetChat=function(){this._chatid="",this._chat=null,this._lastBreak=this._lastPlatform=this._lastuid=this._lastchatid="",sessionStorage.removeItem("lcx-chatid"),this.$msgs&&(this.$msgs.innerText=null),this.delAttr("chat-id"),this.delAttr("chat-status"),this.delAttr("op-status")},nightBird.prototype.createTmpChat=function(i){if(this.resetChat(),i){i=$jscomp.makeIterator(i);for(var j=i.next();!j.done;j=i.next())j=j.value,this.createMsg("basic","_initMsg-"+this.rand(),{date:Date.now(),unread:!0,msg:j,tmpMsg:!0,isYou:!0,sound:"first-msg"})}this.goPage("online")},nightBird.prototype.mode=function(i){this._mode=i,this.attr("mode",i),this.showOps(),this.refreshAwayUI(),this.event.emit("mode",i)},nightBird.prototype.goPage=function(i){if(i&&this._popup!==i){var j=!1,o=document.createElement("div"),q=this._d.getElementById("__lcx-popup-header-"+i),r=this._d.getElementById("__lcx-popup-body-"+i),s=this._d.getElementById("__lcx-popup-footer-"+i);return(q&&(o.classList.add("__lcx-fadein"),o.innerHTML=q.innerHTML,this.$pchead.innerText="",this.$pchead.appendChild(o),j=!0),r&&(this.$pcbody.innerHTML=r.innerHTML,j=!0),s&&(this.$pcfoot.innerHTML=s.innerHTML,j=!0),j)?(this._popup=i,localStorage.setItem("lcx-popup",i),this.$popup.setAttribute("data-name",i),this._onOpenPopupPage(i),!0):(this.open(this.opts.initPopup),!1)}},nightBird.prototype.pushMsg=function(i,j){var o=this;j=void 0===j?"basic":j,this.freezeReply(!0);var q="_initMsg-"+this.rand(),r=firebase.database.ServerValue.TIMESTAMP;this._chatid?(this.$_chats[this._chatid].archived&&this.db.ref("chats/"+this._chatid+"/archived").set(null),this.db.ref("messages/"+this._chatid).push({chatid:this._chatid,date:r,msg:i,name:this._uname,platform:"frontend",photoURL:this._user.photoURL,uid:this._uid,type:j})):(this.createMsg(j,q,{time:r,msg:i,unread:!0,meta:this.str.ntf_sending,tmpMsg:!0,isYou:!0,sound:"first-msg"}),this.event.once("newChat",function(){o.freezeReply(!1),o._manualConn=!1}),this.auth.currentUser?this.startChat(i,j):(this._manualConn=!0,this.db.goOnline(),this.event.once("signin",function(){o.startChat(i,j)}),this.auth.signInAnonymously()["catch"](this._onAuthErr.bind(this))))},nightBird.prototype.createMsg=function(i,j,o){if(i=void 0===i?"basic":i,o=void 0===o?{}:o,this.$msgs){var q=new Date,r=Date.now(),s=(o.date?new Date(o.date):q).toDateString(),t=s===q.toDateString();q=new Date(q.setDate(q.getDate()-1)),q=s===q.toDateString();var u=o.date||r;o.uid=o.uid||this._uid||null,o.platform=o.platform||this.opts.platform,o.fullDate=this.time(u,t?this.opts.hourFormat:this.opts.dateFormat+" "+this.opts.hourFormat),u=o.isYou||this._uid===o.uid&&o.platform===this.opts.platform;var v=this._lastBreak&&this._lastBreak!==s,w=o.uid===this._lastuid&&o.platform===this._lastPlatform,x=["lcx-msg-item"],y=this._d.getElementById("__lcx-msg--"+i);if(y){o.msg&&(o.msg=this.sanitize(o.msg));var z="lcx-msg-"+j;this.delObj(this.$popup.querySelector("."+z)),j=document.createElement("div"),j.id=z,j.className="lcx-msg lcx-msg--"+i+" "+z,j.innerHTML=this.replace(y.innerHTML,o,!0),(y=this.$msgs?this.$msgs.lastElementChild:null)&&(z=y.querySelector(".lcx-msg-meta"))&&(z.innerText=""),!w||v?(w=document.createElement("div"),w.innerHTML=this.__msgWrap,o.unread&&x.push("lcx--new"),u&&x.push("lcx--you"),w.className=x.join(" "),w.querySelector(".lcx-msg-container").appendChild(j),w.querySelector(".lcx-msg-avatar img").src=o.avatar||this.opts.companyLogo||this.opts.anonymousImage,o.meta&&(w.querySelector(".lcx-msg-meta").innerHTML=o.meta),v&&(u="",v=document.createElement("div"),r=Math.abs(o.date/1E3)||r,t?u=this.str.date_today:q&&(u=this.str.date_yesterday),v.className="lcx-breakpoint",v.innerHTML="<span datetime=\""+r+"\">"+u+"</span>",u||this.timeago(v.querySelector("span")),this.$msgs.appendChild(v)),this.$msgs.appendChild(w)):(o.unread&&j.classList.add("lcx--new"),u&&j.classList.add("lcx--you"),y&&y.querySelector(".lcx-msg-container").appendChild(j),o.meta&&(y.querySelector(".lcx-msg-meta").innerHTML=o.meta)),o.tmpMsg?this._initMsg=j.id:(this._lastuid=o.uid,this._lastPlatform=o.platform),this.scrollDown(this.$pbody),this._lastBreak=s,o.sound&&this.play(o.sound,this.opts._pluginurl),this._onCreateMsg(i,o.id,o)}}},nightBird.prototype.updateMsgMeta=function(i,j){var o=this._d.getElementById(i);o&&(o=o.parentNode.parentNode.parentNode.querySelector(".lcx-msg-meta"))&&(o.innerHTML=j)},nightBird.prototype.createNtf=function(i,j,o,q){j=void 0===j?"error":j;var r="lcx-ntf-"+this.rand(),s=document.createElement("div");s.id=r,s.className="lcx-ntf lcx-ntf--"+j,s.innerHTML="<span class=\"lcx-ntf-content\">"+i+"</span>",o&&(this.hideNtf(o),s.classList.add("lcx-ntf-group-"+o)),q&&setTimeout(this.delObj.bind(this,r),3E3),this.$ntf.appendChild(s)},nightBird.prototype.hideNtf=function(i){if(i=this._d.getElementsByClassName("lcx-ntf-group-"+i))for(var j=0;j<i.length;j++)this.delObj(i[j])},nightBird.prototype.listenReply=function(i){var o=this;i&&(i.addEventListener("keydown",function(q){this.disabled?q.preventDefault():q&&13===q.keyCode&&!q.shiftKey&&(0!==this.innerText.length&&(o.pushMsg(this.innerHTML),this.innerText=""),q.preventDefault())}),i.addEventListener("paste",function(q){q.preventDefault(),q=q.clipboardData.getData("text/plain"),o._d.execCommand("insertHTML",!1,q)}))},nightBird.prototype.freezeReply=function(i){var j=this.$popup.querySelector(".lcx-reply");j&&((this._freezeReply=i)?(j.disabled=!0,j.classList.add("lcx--freeze")):(j.disabled=!1,j.classList.remove("lcx--freeze")))},nightBird.prototype.showOps=function(){var i=this,j=this.$popup.querySelector(".lcx-ops");if(j){var o,q,r;j.innerText=null,j.classList.remove("__lcx-hide");var s=function f(v){q=i.$_operators[v],r="lcx-op-item-"+v,o=document.createElement("div"),i.delObj(r),o.id=r,o.className="lcx-op-item",o.innerHTML="<div class=\"lcx-op-pic\" title=\""+q.name+"\"><img src=\""+q.photoURL+"\" alt=\"\"></div><span class=\"lcx-op-name\">"+q.name+"</span>",j.appendChild(o)};if(this._chat&&"open"===this._chat.status){this._chat.opid in this.$_operators&&(q=this.$_operators[this._chat.opid]),s=this._chat.opid in this.$_onlineOps?"online":"away";var t=q.photoURL||this.opts.companyLogo;this.attr("op-status",s),this.$popup.querySelector(".lcx-current-op-name").innerHTML=q.name,this.$popup.querySelector(".lcx-current-op-pic").innerHTML="<img src=\""+t+"\" alt=\"\" />",this.$popup.querySelector(".lcx-current-op-desc").innerHTML=this.str["ops_status_"+s]}else if("online"===this._mode&&this.$_onlineOps)for(t in this.$_onlineOps)s(t);else if(this.$_operators){var u=0;for(t in this.$_operators)if(s(t),u++,3==u)break}else j.classList.add("__lcx-hide")}},nightBird.prototype.chatUI=function(){var i=this;if(this._chat){var j=this.$popup.querySelector(".lcx-rating");if(j){this._chat.solved&&j.classList.add("__lcx-hide");var o=function(t){t.preventDefault(),q(this.getAttribute("data-vote"))},q=function d(t){var u="yes"===t;i.updateChat({solved:u},function(){i.createNtf(i.str.ntf_voted,"success","vote",!0),j.classList.add("__lcx-hide"),i.event.emit("vote",i._chatid,u)})},r=this.$popup.querySelectorAll(".lcx-btn-vote");r=$jscomp.makeIterator(r);for(var s=r.next();!s.done;s=r.next())s.value.addEventListener("click",o)}}},nightBird.prototype.inAppMsg=function(i,j,o){var q=this;if(!this._pstate){var r=this._widget.querySelector(".lcx-inApp");this.delObj(r),r=document.createElement("div"),r.className="lcx-inApp",r.setAttribute("data-chat-id",o),r.innerHTML="<div class=\"lcx-inApp-header\">"+j+"</div><div class=\"lcx-inApp-content\">"+i+"</div>",this._widget.insertBefore(r,this._i),r.addEventListener("click",function(s){s.preventDefault(),s=this.getAttribute("data-chat-id"),q.openChat(s),q.open("online",!0)})}},nightBird.prototype.delAppMsgs=function(){var i=this._widget.querySelector(".lcx-inApp");this.delObj(i)},nightBird.prototype.loadCnv=function(){var i=this.$_msgs[this._chatid];if(i){for(var j in i){var o=i[j];this.createMsg(o.type,j,o)}}},nightBird.prototype.showCnvs=function(){var i=this.$popup.querySelector(".lcx-cnvs");if(i&&Object.keys(this._cnvList).length){for(var j in this._cnvList){var o=this._cnvList[j];this.delObj(o.id),i.insertBefore(o,i.firstChild),this.timeago(o.querySelector(".lcx-cnv-time"))}}},nightBird.prototype.createCnv=function(i,j){var o=this;if(!(i in this._cnvList)){var q={};j.opid&&j.opid in this.$_operators&&(q=this.$_operators[j.opid]);var r=document.createElement("a"),s=this._d.getElementById("__lcx-cnv--item"),t=q.photoURL||this.opts.companyLogo||this.opts.anonymousImage;j.author=q.name||this.opts.companyName,j.date=Math.abs(j.date/1E3),t&&(j.avatar="<img src=\""+t+"\" alt=\"\" />"),r.id="lcx-cnv-item-"+i,r.innerHTML=this.replace(s.innerHTML,j,!0),r.className="lcx-cnv lcx-row",r.setAttribute("data-chatid",i),r.addEventListener("click",function(u){u.preventDefault(),u=this.getAttribute("data-chatid"),o.resetChat(),o.openChat(u),o.goPage("online")}),this._cnvList[i]=r}},nightBird.prototype.updateChat=function(i,j){this._chatid?this.db.ref("chats/"+this._chatid).update(i).then(j):j&&j(!1)},nightBird.prototype.readChat=function(i){this.updateChat({lastRead:firebase.database.ServerValue.TIMESTAMP},i),document.title=this._wtitle,window.clearInterval(this._wtimeout),this._chatid in this._unreads&&delete this._unreads[this._chatid],this.updateCount()},nightBird.prototype.updateCount=function(){var i=this.$popup.querySelector(".lcx-count");if(i){var j=0,o=Object.keys(this._unreads).length;if(0<o){for(var q in this._unreads)q!=this._chatid&&j++;0<j?(i.innerText=o,i.classList.remove("__lcx-hide")):i.classList.add("__lcx-hide")}else i.classList.add("__lcx-hide")}},nightBird.prototype.showCollector=function(){var i=this,j=0,o=!0,q=!1,r=this.$_profile;if(this.opts.collectorReqs)for(var s=$jscomp.makeIterator(this.opts.collectorReqs),t=s.next();!t.done;t=s.next())if(t=t.value,console.log(t,t in r),!(t in r)){q=!0;break}if(q){var w,x,u=function(){j=1,i.createMsg("basic","_preCard-"+i.rand(),{date:Date.now(),unread:!0,msg:i.str.collector_precard,uid:"bot",sound:"msg-alt"}),i._cardtimeout=window.setTimeout(v,1500)},v=function(){j=2,o=!1,i.createMsg("collector","_collector-"+i.rand(),{date:Date.now(),unread:!0,msg:"",uid:"bot",sound:"msg-alt"});var A=i.$popup.querySelectorAll(".lcx-form--collector .lcx-form-field");if(A)for(A=$jscomp.makeIterator(A).next();!A.done;){y(A.value);break}},y=function(A){x=A,w=x.querySelector(".lcx-submit-field"),w.addEventListener("click",z),x.addEventListener("submit",z),x.querySelector(".lcx-field").focus()},z=function(A){A.preventDefault(),A=!0;for(var B,C=$jscomp.makeIterator(x.elements),D=C.next();!D.done;D=C.next()){switch(D=D.value,D.nodeName){case"INPUT":case"TEXTAREA":case"SELECT":D.required&&(0===D.value.length?(A=!1,B=i.str.ntf_reqFields):"email"!==D.type||i.isEmail(D.value)?"checkbox"!==D.type||D.checked||(A=!1,B=i.str.ntf_reqFields):(A=!1,B=i.str.ntf_invEmail));}if(A){var E=D.name;"name"===E?E="nickname":"email"===E?E="emailForNtf":"company_name"===E?E="companyName":void 0,i.db.ref("users/"+i._uid+"/"+E).set(D.value),x.classList.add("lcx-field--success"),D.classList.remove("lcx-error"),D.classList.add("lcx-disabled"),D.disabled=!0,x.querySelector(".lcx-valid-field").classList.remove("__lcx-hide"),w.classList.add("__lcx-hide"),x.nextElementSibling?(x.nextElementSibling.classList.remove("__lcx-hide"),y(x.nextElementSibling)):setTimeout(function(){i.createMsg("basic","_preCard-"+i.rand(),{date:Date.now(),unread:!0,msg:i.$_onlineOps?i.str.collector_postcard_online:i.str.collector_postcard_offline,uid:"bot",sound:"msg-alt"})},2E3)}else{D.classList.add("lcx-error"),i.createNtf(B,"error","offlineForm",!0);break}}};this._cardtimeout=window.setTimeout(u,5E3),(q=this.$popup.querySelector(".lcx-reply"))&&q.addEventListener("keyup",function(){if(o)switch(window.clearTimeout(i._cardtimeout),j){case 0:i._cardtimeout=window.setTimeout(u,5E3);break;case 1:i._cardtimeout=window.setTimeout(v,5E3);}})}},nightBird.prototype.refreshAwayUI=function(){var i=this;if("online"===this._popup&&"showOfflineForm"===this.opts.offlineInit){var j=this.$popup.querySelectorAll(".lcx-hideOnOffline"),o=this.$popup.querySelectorAll(".lcx-showOnOffline");if(this._chatid||"away"!==this._mode){for(o=$jscomp.makeIterator(o),q=o.next();!q.done;q=o.next())q=q.value,q.classList.add("__lcx-hide");for(j=$jscomp.makeIterator(j),q=j.next();!q.done;q=j.next())q=q.value,q.classList.remove("__lcx-hide")}else{j=$jscomp.makeIterator(j);for(var q=j.next();!q.done;q=j.next())q=q.value,q.classList.add("__lcx-hide");for(j=$jscomp.makeIterator(o),q=j.next();!q.done;q=j.next())q=q.value,q.classList.remove("__lcx-hide");var r=this.$popup.querySelector(".lcx-form--offline");for(q=this.$_profile,j=$jscomp.makeIterator(r.elements),o=j.next();!o.done;o=j.next())switch(o=o.value,o.name){case"email":"emailForNtf"in q?o.value=q.emailForNtf:"email"in q&&(o.value=q.email);break;case"name":"name"in q&&(o.value=q.name);}var s=this.$popup.querySelector(".lcx-btn--offflineForm");s&&s.addEventListener("click",function(t){t.preventDefault(),t={};var u=r.elements;i.createNtf(i.str.ntf_sending,"blink","offlineForm"),s.classList.add("lcx-disabled");for(var v=$jscomp.makeIterator(u),w=v.next();!w.done;w=v.next())w=w.value,w.classList.remove("lcx-error");for(u=$jscomp.makeIterator(u),w=u.next();!w.done;w=u.next()){w=w.value;var x=!0;switch(v="",w.nodeName){case"INPUT":case"TEXTAREA":case"SELECT":t[w.name]=w.value;}if(w.required&&(0===w.value.length?(x=!1,v=i.str.ntf_reqFields):"email"!==w.type||i.isEmail(w.value)?"checkbox"!==w.type||w.checked||(x=!1,v=i.str.ntf_reqFields):(x=!1,v=i.str.ntf_invEmail)),!x){w.classList.add("lcx-error"),i.createNtf(v,"error","offlineForm",!0),s.classList.remove("lcx-disabled");break}}x&&i.post("sendOffline",t,function(y){s.classList.remove("lcx-disabled"),y&&!y.error?(i.goPage("cnv"),i.createNtf(i.str.ntf_send_success,"success","offlineForm",!0)):i.createNtf(i.str.ntf_smth_wrong,"error","offlineForm",!0)})})}}},nightBird.prototype.attr=function(i,j){i="data-"+i,this._d.body.setAttribute(i,j),this._widget.setAttribute(i,j)},nightBird.prototype.delAttr=function(i){this._d.body.removeAttribute(i),this._widget.removeAttribute(i)},nightBird.prototype._onCreateMsg=function(i,j){this.event.emit("createMsg",i,j)},nightBird.prototype._onOpenPopup=function(){"online"===this._popup&&this.scrollDown(this.$pbody),this.event.emit("openPopup")},nightBird.prototype._onClosePopup=function(){this._popup="",this.event.emit("closePopup")},nightBird.prototype._onOpenPopupPage=function(i){"online"===i?(this.$msgs=this.$popup.querySelector(".lcx-msgs"),this.listenReply(this.$popup.querySelector(".lcx-reply"),!0),this.showOps(),this.loadCnv(),this.chatUI(),this._chatid||this.attr("chat-status","new")):"cnv"==i&&(this.showCnvs(),this.resetChat()),this.actions(),this.refreshAwayUI(),this.event.emit("newPopupPage",i)},nightBird.prototype._onOnlineOpsUpdate=function(i){var j=i.exists()?"online":"away";this.$_onlineOps=i.exists()?i.val():{},this.mode(j),this.opts.hideOffline&&("online"==j?this._widget.classList.remove("lcx--hidden"):this._pstate||this._widget.classList.add("lcx--hidden"))},nightBird.prototype._onConnect=function(){var i=this;this.hideNtf("conn"),this.attr("connected",!0),this._dbInit?this.createNtf(this.str.ntf_connected,"success","conn",!0):(this.db.ref("operators").orderByChild("lastOnline").on("value",function(j){i.$_operators=j.exists()?j.val():{}}),this.db.ref("onlineOps").on("value",this._onOnlineOpsUpdate.bind(this)),this._dbInit=!0,this.event.emit("connect"))},nightBird.prototype._onDisconnect=function(){this._dbInit&&(this.createNtf(this.str.ntf_no_conn,"error","conn"),this.event.emit("disconnect"))},nightBird.prototype._onProfileUpdate=function(i){if(i.exists()){var j=i.val();if(this.$_profile=j,j.chatsAsVisitor)for(var o in j.chatsAsVisitor)this._onNewChat(o);if(o={currentPageUrl:this._w.location.href},!j.nickname)for(var q in this.opts.user._nickname)o[q]=this.opts.user._nickname[q];this.opts.user._custom&&(o.custom=this.opts.user._custom),this.db.ref("users/"+i.key).update(o),this.event.emit("profile",this.$_profile)}},nightBird.prototype._onAuthState=function(i){if(i){this._uid=i.uid,this._uname=i.displayName,this._user=i;var j=firebase.database.ServerValue.TIMESTAMP,o=this.db.ref("users/"+i.uid);o.child("lastSeen").onDisconnect().set(j),window.localStorage.setItem("lcx-refreshToken",i.refreshToken),o.on("value",this._onProfileUpdate.bind(this)),this.startSess(),this.event.emit("signin",i)}else this.resetUser(),this.event.emit("signout",i)},nightBird.prototype._onAuthErr=function(i){this.createNtf(i.message,"error","auth")},nightBird.prototype._onOpenChat=function(i,j){this.event.emit("openChat",i,j)},nightBird.prototype._onNewChat=function(i){i in this._chats||(this._chats[i]=!0,this.db.ref("chats/"+i).on("value",this._onUpdateChat.bind(this)),this.db.ref("chats").on("child_removed",this._onDeleteChat.bind(this)))},nightBird.prototype._onDeleteChat=function(i){i=i.key,i in this.$_chats&&(this.db.ref("chats/"+i).off(),delete this.$_chats[i],delete this.$_msgs[i],delete this.$_members[i],delete this._cnvList[i],this._chatid===i&&(this.resetChat(),this.goPage("cnv")),this.delObj("lcx-cnv-item-"+i),this.event.emit("deleteChat",i))},nightBird.prototype._onUpdateChat=function(i){var j=this;if(i.exists()){var o=i.key;if(i=i.val(),o in this.$_chats)var q="updateChat";else this.$_msgs[o]={},this.$_members[o]={},q=this.db.ref("messages/"+o),q.on("child_added",this._onNewMsg.bind(this)),q.on("child_changed",this._onUpdateMsg.bind(this)),q.on("child_removed",this._onDeleteMsg.bind(this)),this.attr("has-cnv",!0),this.createCnv(o,i),this.showCnvs(),i.notified||this.post("notifyOps",{caseNo:i.caseNo,visitorName:this.$_profile.nickname,msg:i.lastMsg},function(r){r.error||j.db.ref("chats/"+o+"/notified").set(!0)}),q="newChat";this.$_chats[o]=i,this.openChat(this._chatid),this._chatid&&!this._chat&&this.goPage("online"),this._chatid===o&&(this._chat=i),this.showOps(),this.chatUI(),this.event.emit(q,o,i)}},nightBird.prototype._onNewMsg=function(i,j){var o=this,q=i.val(),r=i.key;if(q.chatid in this.$_chats){var s=this.$_chats[q.chatid].lastRead||null;q.__unread=s&&s<q.date&&(q.platform!==this.opts.platform||q.uid!==this._uid)}if(this._initMsg&&(this.updateMsgMeta(this._initMsg,this.str.date_seconds+"."),this._initMsg=""),this.$_msgs[q.chatid][r]=q,s=q.uid===this._uid?"msg-alt":"msg",q.__unread){this.inAppMsg(q.msg,q.name,q.chatid),this.play("msg");var t=this.str.ntf_newMsg_wtitle.replace("%s",q.name);this._wtimeout=window.setInterval(function(){document.title=document.title===t?o._wtitle:t},700),this._unreads[q.chatid]=!0}this.updateCount(),this._chatid===q.chatid&&this.createMsg(q.type,r,{date:q.date,unread:q.__unread||!1,msg:q.msg,uid:q.uid,platform:q.platform,sound:s}),this.freezeReply(!1),this.event.emit("newMsg",r,q,j)},nightBird.prototype._onUpdateMsg=function(i,j){var o=i.val(),q=i.key;this.$_msgs[o.chatid][q]=o,this.event.emit("updateMsg",q,o,j)},nightBird.prototype._onDeleteMsg=function(i,j){var o=i.key,q=i.val();this.$_msgs[q.chatid]&&delete this.$_msgs[q.chatid][o],this.event.emit("deleteMsg",o,q,j)},nightBird.prototype._escRgx=function(i){return i.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1")},nightBird.prototype.replace=function(i,j,o){for(var q in j){var r=o?"{"+q+"}":q;i=i.replace(new RegExp(this._escRgx(r),"g"),j[q])}return i},nightBird.prototype.play=function(i){(i=new Audio(this.opts._pluginurl+"/assets/sounds/"+i+".mp3").play())&&"undefined"!=typeof Promise&&i instanceof Promise&&i["catch"](function(){})},nightBird.prototype.sanitize=function(i){return i=i.replace(/(\b(https?|ftp):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gim,"<a href=\"$1\" target=\"_blank\">$1</a>"),i=i.replace(/(^|[^\/])(www\.[\S]+(\b|$))/gim,"$1<a href=\"http://$2\" target=\"_blank\">$2</a>"),i=i.replace(/(([a-zA-Z0-9\-_\.])+@[a-zA-Z_]+?(\.[a-zA-Z]{2,6})+)/gim,"<a href=\"mailto:$1\">$1</a>")},nightBird.prototype.rand=function(i){return Math.floor(Math.random()*(void 0===i?9999999:i))+1},nightBird.prototype.delObj=function(i){"string"==typeof i&&(i=this._d.getElementById(i)),i&&i.parentNode.removeChild(i)},nightBird.prototype.timeago=function(i){var j={prefix:this.str.date_prefix,suffix:this.str.date_suffix,seconds:this.str.date_seconds,minute:this.str.date_minute,minutes:this.str.date_minutes,hour:this.str.date_hour,hours:this.str.date_hours,day:this.str.date_day,days:this.str.date_days,month:this.str.date_month,months:this.str.date_months,year:this.str.date_year,years:this.str.date_years},o=function c(r,t){var s=j[r]&&j[r].replace(/%d/i,Math.abs(Math.round(t)));return"seconds"!==r&&(s+=j.suffix),s};i&&(i.innerHTML=function d(r){if(r){r=r.replace(/\.\d+/,""),r=r.replace(/-/,"/").replace(/-/,"/"),r=r.replace(/T/," ").replace(/Z/," UTC"),r=r.replace(/([\+\-]\d\d):?(\d\d)/," $1$2"),r=new Date(1E3*r||r),r=.001*(new Date().getTime()-r)>>0;var s=r/60,t=s/60,u=t/24,v=u/365;return j.prefix+(45>r&&o("seconds",r)||90>r&&o("minute",1)||45>s&&o("minutes",s)||90>s&&o("hour",1)||24>t&&o("hours",t)||42>t&&o("day",1)||30>u&&o("days",u)||45>u&&o("month",1)||365>u&&o("months",u/30)||1.5>v&&o("year",1)||o("years",v))}}(i.getAttribute("datetime")))},nightBird.prototype.time=function(i,j){var o=new Date(i),q={Y:o.getFullYear(),m:o.getMonth()+1,d:o.getDate(),H:o.getHours(),i:o.getMinutes(),s:o.getSeconds()};return 1===q.H.toString().length&&(q.H="0"+q.H),1===q.i.toString().length&&(q.i="0"+q.i),j=j.replace(/Y|m|d|H|i|s/gi,function(r){return q[r]})},nightBird.prototype.isEmail=function(i){return /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(i)},nightBird.prototype.post=function(i,j,o){j.mode=i,j.action=j.action||"lcx_action",j._ajax_nonce=this.opts.ajax.nonce;var q=new XMLHttpRequest;for(var r in i=new FormData,q.open("POST",this.opts.ajax.url,!0),q.onreadystatechange=function(){4==q.readyState&&(200==q.status?o&&o(JSON.parse(q.responseText)):o&&o(null))},j)i.append(r,j[r]);q.send(i)},nightBird.prototype.scrollDown=function(i){i.scrollTop=i.scrollHeight};